...
# DesignName OutputDirectory NetlistDirectory EarlyLibraryPath       #
# LateLibraryPath ConstraintsFile                                    #
# If you are modifying this script, please use above variables as    #
# starting point. Use 'puts' command to report above variables       #
#--------------------------------------------------------------------#
...
puts "\nInfo: Below are the list of initial variables and their values. User can use these variables for further debug. Use 'puts \$variable_name' command to query value of below variables"
